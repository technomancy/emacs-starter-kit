...
- System specific config :: Finally, you may want to configure
     ...
     or =.org= which will allow host-specific configuration.

Some miscellaneous configuration suggestions
- =grep='ing through these starter-kit-* files can provide useful
  examples for how to do things like install major modes, define
  keybindings, etc..
