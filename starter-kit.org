...
2. If you don't already have one, checkout a version of the starter
   kit using git (If you don't have git installed see
   http://git-scm.com/ for information on installing and using git).
   #+begin_src sh
     git clone http://github.com/eschulte/emacs-starter-kit.git
   #+end_src
3. Move the resulting directory to =~/.emacs.d= [1]
4. Install the Org-mode [[http://www.kernel.org/pub/software/scm/git/docs/user-manual.html#submodules][submodules]] with the following -- if you're new
