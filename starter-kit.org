...
3. Install the Org-mode and Org-babel [[http://www.kernel.org/pub/software/scm/git/docs/user-manual.html#submodules][submodules]] with the following
   #+begin_src sh
   git submodule init
