...
#+begin_src emacs-lisp
(org-babel-load-file "starter-kit-defuns.org")
#+end_src
...
#+begin_src emacs-lisp
(org-babel-load-file "starter-kit-bindings.org")
#+end_src
...
#+begin_src emacs-lisp
(org-babel-load-file "starter-kit-registers.org")
#+end_src
...
#+begin_src emacs-lisp
(org-babel-load-file "starter-kit-org.org")
#+end_src
...
#+begin_src emacs-lisp
(org-babel-load-file "starter-kit-eshell.org")
#+end_src
...
#+begin_src emacs-lisp
(org-babel-load-file "starter-kit-lisp.org")
#+end_src
...
#+begin_src emacs-lisp
(org-babel-load-file "starter-kit-ruby.org")
#+end_src
...
#+begin_src emacs-lisp
(org-babel-load-file "starter-kit-js.org")
#+end_src
...
#+begin_src emacs-lisp
(org-babel-load-file "starter-kit-perl.org")
#+end_src
