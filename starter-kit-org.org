...
** Links to git files
this is using Reimar Finken's [[http://github.com/ReimarFinken/org-git-link][org-git-link]]
#+begin_src emacs-lisp
  (add-to-list 'load-path (expand-file-name "org-git-link" elisp-source-dir))
