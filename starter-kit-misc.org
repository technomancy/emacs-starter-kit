...
** Color Theme
The [[http://www.nongnu.org/color-theme/][Color Theme]] package supplies support for saving sharing and
changing the coloring of your Emacs buffers.  To view available color
themes on your system run =M-x color-theme-select=.  See the color
theme website and EmacsWiki pages for more information.
...
to permanently change to a new color theme
(e.g. color-theme-railscast), just call that theme's function from
your initialization (e.g. add =(color-theme-railscast)=).
